...
def astar_search(start, h_func, moves_func):
    ...
    while frontier:
        ...
        for s2 in moves_func(s):
            last_spell = s2["casted_spells"][-1]
            # print("LS " + last_spell)
            new_cost = path_cost[str(s)] + SPELLS[last_spell]
            # new_cost = path_cost[str(s)] + 1
            # print("NC " + str(new_cost))
...
def state_cost(state):
    ...
    print(1500 - score + value)
    return 1500 - score + value
